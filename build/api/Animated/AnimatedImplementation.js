...
var _flattenStyle=require('../../propTypes/flattenStyle');var _flattenStyle2=_interopRequireDefault(_flattenStyle);
...
var _SpringConfig=require('./SpringConfig');var _SpringConfig2=_interopRequireDefault(_SpringConfig);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{'default':obj};}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}
...
}return __debouncedOnEnd;}()}]);return Animation;}();var
...
function DecayAnimation(config){_classCallCheck(this,DecayAnimation);var _this4=_possibleConstructorReturn(this,(DecayAnimation.__proto__||Object.getPrototypeOf(DecayAnimation)).call(this));
...
function SpringAnimation(config){_classCallCheck(this,SpringAnimation);var _this5=_possibleConstructorReturn(this,(SpringAnimation.__proto__||Object.getPrototypeOf(SpringAnimation)).call(this));
...
function AnimatedInterpolation(parent,interpolation){_classCallCheck(this,AnimatedInterpolation);var _this6=_possibleConstructorReturn(this,(AnimatedInterpolation.__proto__||Object.getPrototypeOf(AnimatedInterpolation)).call(this));
...
}return __detach;}()}]);return AnimatedAddition;}(AnimatedWithChildren);var
...
this._a.__removeChild(this);
this._b.__removeChild(this);
}return __detach;}()}]);return AnimatedMultiplication;}(AnimatedWithChildren);var


AnimatedDivision=function(_AnimatedWithChildren6){_inherits(AnimatedDivision,_AnimatedWithChildren6);
...
_this13._a=a;
_this13._b=b;return _this13;
}_createClass(AnimatedDivision,[{key:'__getValue',value:function(){function __getValue()
...
this._a.__removeChild(this);
this._b.__removeChild(this);
}return __detach;}()}]);return AnimatedDivision;}(AnimatedWithChildren);var
...
}return __detach;}()}]);return AnimatedTransform;}(AnimatedWithChildren);var
...
_this17._style=newStyle;return _this17;
...
}return __detach;}()}]);return AnimatedStyle;}(AnimatedWithChildren);var


AnimatedProps=function(_Animated2){_inherits(AnimatedProps,_Animated2);
function AnimatedProps(props,callback){_classCallCheck(this,AnimatedProps);var _this18=_possibleConstructorReturn(this,(AnimatedProps.__proto__||Object.getPrototypeOf(AnimatedProps)).call(this));

_this18._props=props;
if(_this18._props.style){
_this18._props=_extends({},
_this18._props,{
style:new AnimatedStyle(_this18._props.style)});
...
{
this._callback();
}return update;}()}]);return AnimatedProps;}(Animated);var


AnimatedTracking=function(_Animated3){_inherits(AnimatedTracking,_Animated3);
function AnimatedTracking(value,parent,animationClass,animationConfig,callback){_classCallCheck(this,AnimatedTracking);var _this19=_possibleConstructorReturn(this,(AnimatedTracking.__proto__||Object.getPrototypeOf(AnimatedTracking)).call(this));

_this19._value=value;
_this19._parent=parent;
_this19._animationClass=animationClass;
_this19._animationConfig=animationConfig;
...
function loop(animation){var iterations=arguments.length>1&&arguments[1]!==undefined?arguments[1]:-1;
var isFinished=false;
var iterationsSoFar=0;
return{
start:function(){function start(callback){
function restart(){var result=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{finished:true};
if(
isFinished||
